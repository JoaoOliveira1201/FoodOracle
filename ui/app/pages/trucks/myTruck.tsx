      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Manage and update your truck information
          </p>
        </div>
        ...
        {!truck ? (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">You need to create a truck to start receiving assignments</p>
            </div>
            
            {!showCreateTruckForm ? (
              <Button 
                label="Create My Truck" 
              ...
              <div className="max-w-md mx-auto">
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Load Capacity (kg)</label>
                    <input 
                      type="number"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(truck.status)}`}>
                    {truck.status}
                  </span>
              ...
              {truck.current_location && (
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Latitude: {truck.current_location.latitude.toFixed(6)}, Longitude: {truck.current_location.longitude.toFixed(6)}
                  </p>
                </div>
              )}
            </div>
